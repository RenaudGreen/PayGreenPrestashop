...
class Paygreen extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        $this->description =
            $this->l('The french payment solution that has a positive impact on society and the environment');
